        ...
        <div className="space-y-6">
          ...
          {featuredProjects.map((project, index) => (
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="flex items-center bg-white border border-gray-200 rounded-xl overflow-hidden shadow hover:shadow-lg transition-all duration-300"
            >
              ...
              <div className="p-4 flex flex-col justify-between w-full">
                <div className="flex items-center gap-2 text-[#008236] font-semibold mb-1">
                  {project.name}
                </div>
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {project.tools.map((tool, i) => (
                    <span
                      key={i}
                      className="text-[11px] px-2 py-0.5 bg-[#008236]/10 text-[#008236] rounded-full"
                    >
                      {tool}
                    </span>
                  ))}
